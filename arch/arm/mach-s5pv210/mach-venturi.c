...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC0 (1000 * SZ_1K)
// Disabled to save memory (we can't find where it's used)
//#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC1 (9900 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC2 (1000 * SZ_1K)
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_JPEG (1000 * SZ_1K)
